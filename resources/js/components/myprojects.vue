            ...
            <div class="main_back">
                ...
                <div class="middle_section column-section">
                    ...
                    <div class="tmmytasksmain-middle-panel">
                        <ul>
                            <li>
                                <h2>My Projects I created it </h2>
                                <table>
                                    <tbody>
                                        <div v-if="myProjectsFounded">
                                            <tr>
                                                <div v-for="myProjectFounded in myProjectsFounded" :key="myProjectFounded.id">
                                                    <a :href="`/sphere/${myProjectFounded.id}/posts`">{{myProjectFounded.name}}</a>

                                                    <div v-if="myProjectFounded.request_joining_status=='pending_status_request_joining'">
                                                        <span style="color: red">Pending Your Request</span>
                                                    </div>
                                                    <div v-if="myProjectFounded.request_joining_status=='accepted_status_request_joining'">
                                                        <span style="color: red">Pending Your Request</span>
                                                    </div>
                                                    <div v-if="myProjectFounded.invitation_status=='pending_inivitation_status'">
                                                        <span style="color: red">Pending Your Request</span>
                                                    </div>
                                                    <div v-if="myProjectFounded.invitation_status=='accepted_inivitation_status'">
                                                        <span style="color: red">Pending Your Request</span>
                                                    </div>
                                                </div>
                                            </tr>
                            ...
                            <li>
                                <h2>My Projects I joined in it </h2>
                                <table>
                                    <tbody>
                                        <div v-if="myProjectsJoined">
                                            <tr>
                                                <div v-for="myProjectJoined in myProjectsJoined" :key="myProjectJoined.id">
                                                    <a :href="`/sphere/${myProjectJoined.id}/posts`">{{myProjectJoined.name}}</a>

                                                    <div v-if="myProjectJoined.request_joining_status=='pending_status_request_joining'">
                                                        <span style="color: red">Pending Your Request</span>
                                                    </div>
                                                    <div v-if="myProjectJoined.request_joining_status=='accepted_status_request_joining'">
                                                        <span style="color: red">Pending Your Request</span>
                                                    </div>
                                                    <div v-if="myProjectJoined.invitation_status=='pending_inivitation_status'">
                                                        <span style="color: red">Pending Your Request</span>
                                                    </div>
                                                    <div v-if="myProjectJoined.invitation_status=='accepted_inivitation_status'">
                                                        <span style="color: red">Pending Your Request</span>
                                                    </div>
                                                </div>
                                            </tr>
...
export default {
    data() {
        return {
            ...
            myProjectsFounded: null,
            myProjectsJoined: null
        };
    },
    methods: {
                getError(id) {
    ...
    mounted() {
        ...
        axios
            .get(
                'http://127.0.0.1:8000/user/my-projects-founded'
            )

            .then(res => {
                setTimeout(() => {

                    this.myProjectsFounded = res.data.data;
                }, 1000)
            }).catch(err => this.callErrorMessage(err.response.status))

        axios
            .get(
                'http://127.0.0.1:8000/user/my-projects-joined'
            )

            .then(res => {
                this.myProjectsJoined = res.data.data;
            }).catch(err => this.callErrorMessage(err.response.status))
