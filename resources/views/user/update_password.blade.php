...
<div style="margin-top: 49px;">
  ...
  <form action="{{url('/user/update-password/'.$dataThisUser->id)}}" method="post">{{csrf_field()}}
  <div class="form-group" style="margin-left: 137px;margin-top: 60px;">
  ...
  <button name="submit" class="btn btn-primary"style=" margin-left: 492px;width: 24%;">update my password</button>
